...
if(isset($_POST['submit'])){
    ...
    $q12_rating = $_POST['q12_rating'];

    $data = "INSERT INTO professionalfeedback(name, email, mobile, designation, organization, q1_rating, q2_rating, q3_rating, q4_rating, q5_rating, q6_rating, q7_rating, q8_rating, q9_rating, q10_rating, q11_rating, q12_rating) VALUES ('$name', '$email', '$mobile', '$designation', '$organization', '$q1_rating', '$q2_rating', '$q3_rating', '$q4_rating','$q5_rating', '$q6_rating', '$q7_rating', '$q8_rating' , '$q9_rating', '$q10_rating', '$q11_rating','$q12_rating')";
...
<head>
    ...
    <link rel="stylesheet" href="./css/professionalfeedback.css">
...
<body>
    <div class="main-container">
        ...
        <div class="right-container">
            <div>
                <h2>Professional Feedback Form</h2>
            </div>
        </div>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                <div class="form-inputs">
                    ...
                    <div class="email">
                        ...
                        <input type="email" name="email" id="email" placeholder="xyz@gmail.com" autocomplete="off" required>
                    </div>
                    <div class="mobile">
...
<!--                 
                ...
                <div class="fb_questions">
                    ...
                    <div class="que ">
                        <h2>Que12:Course outcome of the syllabus is well defined and cleared.</h2>
                        <!-- <label for="rating" class="qu1-label">Que1 :Syllabus is suitable to the course</label> -->
                        <div class="rating">

                            <input type="radio" id="star5_q12" name="q12_rating" value="5"><label for="star5_q12"></label>
                            <input type="radio" id="star4_q12" name="q12_rating" value="4"><label for="star4_q12"></label>
                            <input type="radio" id="star3_q12" name="q12_rating" value="3"><label for="star3_q12"></label>
                            <input type="radio" id="star2_q12" name="q12_rating" value="2"><label for="star2_q12"></label>
                            <input type="radio" id="star1_q12" name="q12_rating" value="1"><label for="star1_q12"></label>
                        </div>
                    </div>
